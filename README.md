...
- 对于反取证，Macbook和iPhone，有没有哪些缺陷（或不足） ？
    ...
    - 未来有无改进空间？（ 对缺陷 2 ）
    	- 那肯定是有的。苹果应该允许用户，通过Siri语音，锁屏身边所有设备，或 虽是异地 但同Apple ID下的所有设备。更进一步，如果Siri能通过语音接受销毁Pin码，销毁用户设置同销毁Pin码的所有苹果设备。
     	- 一旦用户大喊：“Siri ，锁屏所有设备”，那凡是屋子内的苹果设备都被秒锁屏。 连Apple TV都给你锁屏了 🤣 警方压根就解不开
      	- 一旦用户大喊：“Siri ，ABC12345678“，Siri听到后，直接开始销毁，还会控制远端设备销毁 🤣 想想就觉得酸爽。
      	- 所以，什么才叫 系统级 “原生支持” 反取证？？？纯软件方案是没有前途的。
